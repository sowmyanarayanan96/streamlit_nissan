...
# with col1:
#     st.selectbox("Claim Region", ["USA", "Europe", "Asia"])
# with col2:
...
# col1.metric(label="Total Claim Count", value="354", delta="8.5% up")
# col2.metric(label="Total Claim Amount", value="$3,298", delta="2.3% up")
# col3.metric(label="Total Recovery Amount", value="$6,458.87", delta="6% up")
# col4.metric(label="Total Parts Amount", value="$27,000", delta="32% up")
# col5.metric(label="Total Labour Amount", value="$358.43", delta="65% up")



# # Bar Chart - Claim Volume Analysis
# # st.markdown("### Claim Volume Analysis")
